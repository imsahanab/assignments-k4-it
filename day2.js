...
// Worker thread allows us to run CPU-heavy tasks by multiple threads
// in a separate thread without blocking the main thread.

// Real-life example:
// we are doing billing in a shop.
// If one customer asks  to count 10,000 items,
// we give that work to an assistant.
// we continue serving other customers.
...
// Real-life example:
// we keep throwing waste inside a room
// but never clean it.
...
// What is Inheritance?
// Child class can use properties and methods
// of parent class.
...
// Same power button works differently on TV and Mobile.
...
// What is Abstraction?
// Hide complex implementation details and show only necessary functionality./ Abstraction hides internal complexity
// and exposes only the required functionality.
